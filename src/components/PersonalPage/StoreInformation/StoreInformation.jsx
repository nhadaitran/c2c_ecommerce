...
import { Message, Star, CalendarToday, Room, Feedback, Phone, VisibilityOff, Settings, StarBorder,PersonAdd } from '@material-ui/icons';
    ...
    return (
        <Grid container spacing={0}   xs={12}>
            ...
            <Paper className={classes.paper} elevation={0}>
                ...
                <Button className={classes.sbutton} variant="outlined" color="primary" ><PersonAdd />Theo Dõi</Button>
                <Button className={classes.sbutton} variant="outlined"  color="primary"><StarBorder />Đánh giá</Button>
