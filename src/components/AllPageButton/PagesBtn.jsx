...
export default function PagesBtn() {
  ...
  const options = [
    ...
    <Typography component={Link} to='/profile' variant="subtitle1" color="inherit" className={classes.title}> Trang cá nhân</Typography>,
    <Typography component={Link} to='/store' variant="subtitle1" color="inherit" className={classes.title}> Trang cửa hàng</Typography>,
